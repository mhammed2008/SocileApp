...
<label <?php echo e($attributes->merge(['class' => 'block font-medium text-2xl text-white'])); ?>>
    <?php echo e($value ?? $slot); ?>

</label>
<?php /**PATH C:\xampp\htdocs\youtube\resources\views/components/input-label.blade.php ENDPATH**/ ?>